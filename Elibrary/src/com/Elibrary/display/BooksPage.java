...
/**
 * Servlet implementation class BooksPage
 */
public class BooksPage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(obj!=null) {
			ArrayList<Book> book =RetriveBook.getBook();
		...
		out.println("<main>\r\n" + 
				...
				"                <input type=\"search\" id=\"searchb\" placeholder=\"Find Books...\">\r\n" + 
			...
			for (int i = 0; i < book.size(); i++) {
				out.println("<tr>\r\n" + 
						...
						"                    <td style=\"border: 2px solid ghostwhite;background-color :crimson;border-collapse: collapse;text-align: center; \">"+book.get(i).getIsseStatus()+"</td>\r\n" + 
						"                  \r\n" + 
						"                </tr>");
			}
			out.println("</table>\r\n" + 
